...
type KeyGenerator interface {
	...
	GenWeightedRotationKeysForRotations(ks []int, includeSwapRows bool, sk *rlwe.SecretKey, matrix LinearTransform) (rks *rlwe.RotationKeySet)
}
...
func (keygen *keyGenerator) GenWeightedRotationKeysForRotations(ks []int, includeConjugate bool, sk *rlwe.SecretKey, matrix LinearTransform) (rks *rlwe.RotationKeySet) {
