...
func NewBootstrapper(params ckks.Parameters, btpParams Parameters, btpKey rlwe.EvaluationKey) (btp *Bootstrapper, err error) {
	...
	var flag = 0
	if btpParams.CoeffsToSlotsParameters.LevelConserved {
		flag++
	}

	if btpParams.CoeffsToSlotsParameters.LevelStart-btpParams.CoeffsToSlotsParameters.Depth(true)+flag != btpParams.EvalModParameters.LevelStart {
